    ...
    where TEntity : class, IEntity
{
    ...
    public virtual async Task<TGetOutputDto> UpdateAsync(TKey id, TUpdateInput input)
    {
        ...
        if (entity is IHasConcurrencyStamp concurrentEntity && input is IHasConcurrencyStamp concurrentInput)
        {
            concurrentEntity.ConcurrencyStamp = concurrentInput.ConcurrencyStamp;
        }
